...
class RobotArmController:
    ...
    def define_macros(self):
        self.macros = {
            ...
            "hook-to-x": [ [2, 0.0], [3, 90.0], [4, 0.0], [5, 0.0], [6, 45.0]],
            "hook-down-x":[ [2, 0.0], [3, 90.0], [4, -70.0], [5, 0.0], [6, 45.0]],
            "reach-out-x":[ [2, 0.0], [3, 30.0], [4, -70.0], [5, 30.0], [6, 45.0]],

            "hook-to-y": [ [2, 0.0], [3, 90.0], [4, 0.0], [5, 0.0], [6, -45.0]],
            "hook-down-y":[ [2, 0.0], [3, 90.0], [4, -70.0], [5, 0.0], [6, -45.0]],
            "reach-out-y":[ [2, 0.0], [3, 30.0], [4, -70.0], [5, 30.0], [6, -45.0]],
